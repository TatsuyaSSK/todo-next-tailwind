    ...
    <>
      ...
      <div>
        <section>
          ...
          <p className="mt-5">
            TatsuyaSSK（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
          </p>
        </section>
        ...
        <section className="mt-5">
          <h2 className="text-2xl">第2条（個人情報の収集方法）</h2>
          <p className="mt-5">
            当社は，ユーザーが利用登録をする際に氏名，生年月日，住所，電話番号，メールアドレス，銀行口座番号，クレジットカード番号，運転免許証番号などの個人情報をお尋ねすることがあります。また，ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を,当社の提携先（情報提供元，広告主，広告配信先などを含みます。以下，｢提携先｣といいます。）などから収集することがあります。
          </p>
        </section>
        <section className="mt-5">
          <h2 className="text-2xl">第3条（個人情報を収集・利用する目的）</h2>
          <p className="mt-5">
        ...
        <section className="mt-5">
          <h2 className="text-2xl">第5条（個人情報の第三者提供）</h2>
          <p className="mt-5">
        ...
        <section className="mt-5">
          <h2 className="text-3xl">第6条（個人情報の開示）</h2>
          <p className="mt-5">
        ...
        <section className="mt-5">
          <h2 className="text-2xl">第10条（お問い合わせ窓口）</h2>
          <p className="mt-5">
            本ポリシーに関するお問い合わせは，お問い合わせページからお願いいたします。
          </p>
        </section>
      </div>
    </>
